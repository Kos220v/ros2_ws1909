...
SDA → GPIO2/pin 3, SCL → GPIO3/pin 5. Не подключать к 5 В.
...
Реализован ограниченный SH-2/SHTP профиль: soft reset, Product ID handshake,
...
Game Rotation Vector, AR/VR stabilization, GPIO INT/RST, FRS/DCD-записи,
...
выходит с ошибкой и launch повторяет запуск через 3 с. Недостаточная точность
